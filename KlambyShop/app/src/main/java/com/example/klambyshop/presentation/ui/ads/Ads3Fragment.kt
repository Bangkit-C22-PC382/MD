...
import com.example.klambyshop.databinding.FragmentAdd3Binding
import com.example.klambyshop.presentation.ui.login.LoginActivity


class Ads3Fragment : Fragment() {
    private var _viewBinding: FragmentAdd3Binding? = null
    ...
    override fun onCreateView(
        ...
        _viewBinding = FragmentAdd3Binding.inflate(inflater,container,false)
